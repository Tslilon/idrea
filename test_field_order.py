        ...
        if creds:
            ...
            if len(formatted_values) >= 13:
                ...
                final_values = [
                    ...
                    formatted_values[11] if len(formatted_values) > 11 else "", # invoice_number
                    formatted_values[12] if len(formatted_values) > 12 else ""  # supplier_id
                ]
